...
------------ | ------------- | ------------- | -------------
*AiApiKeyApi* | [**create_ai_api_key**](docs/AiApiKeyApi.md#create_ai_api_key) | **POST** /ai/api-key | [BETA] Create AI API Key
*AiApiKeyApi* | [**delete_ai_api_key**](docs/AiApiKeyApi.md#delete_ai_api_key) | **DELETE** /ai/api-key/{id} | [BETA] Delete AI API Key
*AiApiKeyApi* | [**get_ai_api_key**](docs/AiApiKeyApi.md#get_ai_api_key) | **GET** /ai/api-key/{id} | [BETA] Get AI API Key
*AiApiKeyApi* | [**get_user_org_consumption_quota**](docs/AiApiKeyApi.md#get_user_org_consumption_quota) | **GET** /ai/quota | [BETA] Get Organization Consumption Quota
*AiApiKeyApi* | [**list_ai_api_keys**](docs/AiApiKeyApi.md#list_ai_api_keys) | **GET** /ai/api-key | [BETA] List AI API Keys
*AiApiKeyApi* | [**reveal_ai_api_key**](docs/AiApiKeyApi.md#reveal_ai_api_key) | **GET** /ai/api-key/{id}/reveal | [BETA] Reveal AI API Key
*AiApiKeyApi* | [**rotate_ai_api_key**](docs/AiApiKeyApi.md#rotate_ai_api_key) | **POST** /ai/api-key/{id}/rotate | [BETA] Rotate AI API Key
*AiApiKeyApi* | [**update_ai_api_key**](docs/AiApiKeyApi.md#update_ai_api_key) | **PATCH** /ai/api-key/{id} | [BETA] Update AI API Key
...
*ApiKeyApi* | [**create_api_key**](docs/ApiKeyApi.md#create_api_key) | **POST** /api-key | Create a new API key
*ApiKeyApi* | [**delete_api_key**](docs/ApiKeyApi.md#delete_api_key) | **DELETE** /api-key/{id} | Delete an API key
*ApiKeyApi* | [**get_api_key**](docs/ApiKeyApi.md#get_api_key) | **GET** /api-key/{id} | Get API key
*ApiKeyApi* | [**list_api_keys**](docs/ApiKeyApi.md#list_api_keys) | **GET** /api-key | List API keys
...
*ClusterApi* | [**list_sks_cluster_deprecated_resources**](docs/ClusterApi.md#list_sks_cluster_deprecated_resources) | **GET** /sks-cluster-deprecated-resources/{id} | Resources that are scheduled to be removed in future kubernetes releases
*ClusterApi* | [**list_sks_cluster_versions**](docs/ClusterApi.md#list_sks_cluster_versions) | **GET** /sks-cluster-version | List available versions for SKS clusters
*ClusterApi* | [**list_sks_clusters**](docs/ClusterApi.md#list_sks_clusters) | **GET** /sks-cluster | List SKS clusters
*ClusterApi* | [**rotate_sks_ccm_credentials**](docs/ClusterApi.md#rotate_sks_ccm_credentials) | **PUT** /sks-cluster/{id}/rotate-ccm-credentials | Rotate Exoscale CCM credentials
*ClusterApi* | [**rotate_sks_csi_credentials**](docs/ClusterApi.md#rotate_sks_csi_credentials) | **PUT** /sks-cluster/{id}/rotate-csi-credentials | Rotate Exoscale CSI credentials
*ClusterApi* | [**rotate_sks_karpenter_credentials**](docs/ClusterApi.md#rotate_sks_karpenter_credentials) | **PUT** /sks-cluster/{id}/rotate-karpenter-credentials | Rotate Exoscale Karpenter credentials
*ClusterApi* | [**rotate_sks_operators_ca**](docs/ClusterApi.md#rotate_sks_operators_ca) | **PUT** /sks-cluster/{id}/rotate-operators-ca | Rotate operators certificate authority
*ClusterApi* | [**update_sks_cluster**](docs/ClusterApi.md#update_sks_cluster) | **PUT** /sks-cluster/{id} | Update an SKS cluster
...
*CryptoApi* | [**decrypt**](docs/CryptoApi.md#decrypt) | **POST** /kms-key/{id}/decrypt | Decrypt
*CryptoApi* | [**encrypt**](docs/CryptoApi.md#encrypt) | **POST** /kms-key/{id}/encrypt | Encrypt
*CryptoApi* | [**generate_data_key**](docs/CryptoApi.md#generate_data_key) | **POST** /kms-key/{id}/generate-data-key | Generate Data Encryption Key
*CryptoApi* | [**re_encrypt**](docs/CryptoApi.md#re_encrypt) | **POST** /kms-key/{id}/re-encrypt | Re-encrypt
...
*DbaasApi* | [**create_dbaas_clickhouse_user**](docs/DbaasApi.md#create_dbaas_clickhouse_user) | **POST** /dbaas-clickhouse/{service_name}/user | [BETA] Create a DBaaS ClickHouse user
...
*DbaasApi* | [**create_dbaas_mysql_database**](docs/DbaasApi.md#create_dbaas_mysql_database) | **POST** /dbaas-mysql/{service_name}/database | Create a DBaaS MySQL database
*DbaasApi* | [**create_dbaas_mysql_user**](docs/DbaasApi.md#create_dbaas_mysql_user) | **POST** /dbaas-mysql/{service_name}/user | Create a DBaaS MySQL user
...
*DbaasApi* | [**create_dbaas_service_clickhouse**](docs/DbaasApi.md#create_dbaas_service_clickhouse) | **POST** /dbaas-clickhouse/{name} | [BETA] Create a DBaaS ClickHouse service
...
*DbaasApi* | [**create_dbaas_service_thanos**](docs/DbaasApi.md#create_dbaas_service_thanos) | **POST** /dbaas-thanos/{name} | Create a DBaaS Thanos service
...
*DbaasApi* | [**delete_dbaas_clickhouse_role**](docs/DbaasApi.md#delete_dbaas_clickhouse_role) | **DELETE** /dbaas-clickhouse/{service_name}/role/{role_uuid} | [BETA] Delete a DBaaS ClickHouse role
*DbaasApi* | [**delete_dbaas_clickhouse_user**](docs/DbaasApi.md#delete_dbaas_clickhouse_user) | **DELETE** /dbaas-clickhouse/{service_name}/user/{user_uuid} | [BETA] Delete a DBaaS ClickHouse user
...
*DbaasApi* | [**delete_dbaas_mysql_database**](docs/DbaasApi.md#delete_dbaas_mysql_database) | **DELETE** /dbaas-mysql/{service_name}/database/{database_name} | Delete a DBaaS MySQL database
*DbaasApi* | [**delete_dbaas_mysql_user**](docs/DbaasApi.md#delete_dbaas_mysql_user) | **DELETE** /dbaas-mysql/{service_name}/user/{username} | Delete a DBaaS MySQL user
*DbaasApi* | [**delete_dbaas_opensearch_user**](docs/DbaasApi.md#delete_dbaas_opensearch_user) | **DELETE** /dbaas-opensearch/{service_name}/user/{username} | Delete a DBaaS OpenSearch user
*DbaasApi* | [**delete_dbaas_pg_connection_pool**](docs/DbaasApi.md#delete_dbaas_pg_connection_pool) | **DELETE** /dbaas-postgres/{service_name}/connection-pool/{connection_pool_name} | Delete a DBaaS PostgreSQL connection pool
*DbaasApi* | [**delete_dbaas_pg_database**](docs/DbaasApi.md#delete_dbaas_pg_database) | **DELETE** /dbaas-postgres/{service_name}/database/{database_name} | Delete a DBaaS Postgres database
*DbaasApi* | [**delete_dbaas_postgres_user**](docs/DbaasApi.md#delete_dbaas_postgres_user) | **DELETE** /dbaas-postgres/{service_name}/user/{username} | Delete a DBaaS Postgres user
*DbaasApi* | [**delete_dbaas_service**](docs/DbaasApi.md#delete_dbaas_service) | **DELETE** /dbaas-service/{name} | Delete a DBaaS service
*DbaasApi* | [**delete_dbaas_service_clickhouse**](docs/DbaasApi.md#delete_dbaas_service_clickhouse) | **DELETE** /dbaas-clickhouse/{name} | [BETA] Delete a ClickHouse service
...
*DbaasApi* | [**delete_dbaas_service_thanos**](docs/DbaasApi.md#delete_dbaas_service_thanos) | **DELETE** /dbaas-thanos/{name} | Delete a Thanos service
...
*DbaasApi* | [**get_dbaas_clickhouse_acl_config**](docs/DbaasApi.md#get_dbaas_clickhouse_acl_config) | **GET** /dbaas-clickhouse/{service_name}/acl-config | [BETA] Get DBaaS ClickHouse ACL configuration
...
*DbaasApi* | [**get_dbaas_service_clickhouse**](docs/DbaasApi.md#get_dbaas_service_clickhouse) | **GET** /dbaas-clickhouse/{name} | [BETA] Get a DBaaS ClickHouse service
...
*DbaasApi* | [**get_dbaas_service_logs**](docs/DbaasApi.md#get_dbaas_service_logs) | **POST** /dbaas-service-logs/{service_name} | Get logs of DBaaS service
*DbaasApi* | [**get_dbaas_service_metrics**](docs/DbaasApi.md#get_dbaas_service_metrics) | **POST** /dbaas-service-metrics/{service_name} | Get metrics of DBaaS service
...
*DbaasApi* | [**get_dbaas_service_thanos**](docs/DbaasApi.md#get_dbaas_service_thanos) | **GET** /dbaas-thanos/{name} | 
...
*DbaasApi* | [**get_dbaas_settings_clickhouse**](docs/DbaasApi.md#get_dbaas_settings_clickhouse) | **GET** /dbaas-settings-clickhouse | [BETA] Get DBaaS ClickHouse settings
...
*DbaasApi* | [**get_dbaas_settings_thanos**](docs/DbaasApi.md#get_dbaas_settings_thanos) | **GET** /dbaas-settings-thanos | Get DBaaS Thanos settings
...
*DbaasApi* | [**list_dbaas_clickhouse_roles**](docs/DbaasApi.md#list_dbaas_clickhouse_roles) | **GET** /dbaas-clickhouse/{service_name}/role | [BETA] List DBaaS ClickHouse roles
*DbaasApi* | [**list_dbaas_clickhouse_users**](docs/DbaasApi.md#list_dbaas_clickhouse_users) | **GET** /dbaas-clickhouse/{service_name}/user | [BETA] List DBaaS ClickHouse users
...
*DbaasApi* | [**reset_dbaas_clickhouse_user_password**](docs/DbaasApi.md#reset_dbaas_clickhouse_user_password) | **PUT** /dbaas-clickhouse/{service_name}/user/{username}/password/reset | [BETA] Reset the credentials of a DBaaS ClickHouse user
...
*DbaasApi* | [**reset_dbaas_opensearch_user_password**](docs/DbaasApi.md#reset_dbaas_opensearch_user_password) | **PUT** /dbaas-opensearch/{service_name}/user/{username}/password/reset | Reset the credentials of a DBaaS OpenSearch user
*DbaasApi* | [**reset_dbaas_postgres_user_password**](docs/DbaasApi.md#reset_dbaas_postgres_user_password) | **PUT** /dbaas-postgres/{service_name}/user/{username}/password/reset | Reset the credentials of a DBaaS Postgres user
*DbaasApi* | [**reset_dbaas_valkey_user_password**](docs/DbaasApi.md#reset_dbaas_valkey_user_password) | **PUT** /dbaas-valkey/{service_name}/user/{username}/password/reset | Reset the credentials of a DBaaS Valkey user
*DbaasApi* | [**reveal_dbaas_clickhouse_user_password**](docs/DbaasApi.md#reveal_dbaas_clickhouse_user_password) | **GET** /dbaas-clickhouse/{service_name}/user/{username}/password/reveal | [BETA] Reveal the secrets of a DBaaS ClickHouse user
*DbaasApi* | [**reveal_dbaas_grafana_user_password**](docs/DbaasApi.md#reveal_dbaas_grafana_user_password) | **GET** /dbaas-grafana/{service_name}/user/{username}/password/reveal | Reveal the secrets of a DBaaS Grafana user
*DbaasApi* | [**reveal_dbaas_kafka_connect_password**](docs/DbaasApi.md#reveal_dbaas_kafka_connect_password) | **GET** /dbaas-kafka/{service_name}/connect/password/reveal | Reveal the secrets for DBaaS Kafka Connect
*DbaasApi* | [**reveal_dbaas_kafka_user_password**](docs/DbaasApi.md#reveal_dbaas_kafka_user_password) | **GET** /dbaas-kafka/{service_name}/user/{username}/password/reveal | Reveal the secrets of a DBaaS Kafka user
*DbaasApi* | [**reveal_dbaas_mysql_user_password**](docs/DbaasApi.md#reveal_dbaas_mysql_user_password) | **GET** /dbaas-mysql/{service_name}/user/{username}/password/reveal | Reveal the secrets of a DBaaS MySQL user
*DbaasApi* | [**reveal_dbaas_opensearch_user_password**](docs/DbaasApi.md#reveal_dbaas_opensearch_user_password) | **GET** /dbaas-opensearch/{service_name}/user/{username}/password/reveal | Reveal the secrets of a DBaaS OpenSearch user
*DbaasApi* | [**reveal_dbaas_postgres_user_password**](docs/DbaasApi.md#reveal_dbaas_postgres_user_password) | **GET** /dbaas-postgres/{service_name}/user/{username}/password/reveal | Reveal the secrets of a DBaaS Postgres user
*DbaasApi* | [**reveal_dbaas_thanos_user_password**](docs/DbaasApi.md#reveal_dbaas_thanos_user_password) | **GET** /dbaas-thanos/{service_name}/user/{username}/password/reveal | Reveal the secrets of a DBaaS Thanos user
*DbaasApi* | [**reveal_dbaas_valkey_user_password**](docs/DbaasApi.md#reveal_dbaas_valkey_user_password) | **GET** /dbaas-valkey/{service_name}/user/{username}/password/reveal | Reveal the secrets of a DBaaS Valkey user
*DbaasApi* | [**start_dbaas_clickhouse_maintenance**](docs/DbaasApi.md#start_dbaas_clickhouse_maintenance) | **PUT** /dbaas-clickhouse/{name}/maintenance/start | [BETA] Initiate ClickHouse maintenance update
...
*DbaasApi* | [**start_dbaas_thanos_maintenance**](docs/DbaasApi.md#start_dbaas_thanos_maintenance) | **PUT** /dbaas-thanos/{name}/maintenance/start | Initiate Thanos maintenance update
*DbaasApi* | [**start_dbaas_valkey_maintenance**](docs/DbaasApi.md#start_dbaas_valkey_maintenance) | **PUT** /dbaas-valkey/{name}/maintenance/start | Initiate Valkey maintenance update
...
*DbaasApi* | [**update_dbaas_service_clickhouse**](docs/DbaasApi.md#update_dbaas_service_clickhouse) | **PUT** /dbaas-clickhouse/{name} | [BETA] Update a DBaaS ClickHouse service
...
*DefaultApi* | [**get_impact_estimate**](docs/DefaultApi.md#get_impact_estimate) | **POST** /environmental-impact/estimate | Return an estimate of the impact of a given usage
*DefaultApi* | [**get_impact_report**](docs/DefaultApi.md#get_impact_report) | **GET** /environmental-impact/report | Return an environmental impact report for the given period
...
*DeploymentApi* | [**create_deployment**](docs/DeploymentApi.md#create_deployment) | **POST** /ai/deployment | Create Deployment
*DeploymentApi* | [**delete_deployment**](docs/DeploymentApi.md#delete_deployment) | **DELETE** /ai/deployment/{id} | Delete Deployment
*DeploymentApi* | [**get_deployment**](docs/DeploymentApi.md#get_deployment) | **GET** /ai/deployment/{id} | Get Deployment
*DeploymentApi* | [**get_deployment_logs**](docs/DeploymentApi.md#get_deployment_logs) | **GET** /ai/deployment/{id}/logs | Get Deployment Logs
*DeploymentApi* | [**get_inference_engine_help**](docs/DeploymentApi.md#get_inference_engine_help) | **GET** /ai/help/inference-engine-parameters | Get inference-engine Help
...
*DomainApi* | [**get_dns_domain_zone_file**](docs/DomainApi.md#get_dns_domain_zone_file) | **GET** /dns-domain/{id}/zone | Retrieve DNS domain zone file
*DomainApi* | [**list_dns_domains**](docs/DomainApi.md#list_dns_domains) | **GET** /dns-domain | List DNS domains
...
*InstanceApi* | [**enable_tpm**](docs/InstanceApi.md#enable_tpm) | **POST** /instance/{id}:enable-tpm | Enable tpm for the instance.
...
*InstanceApi* | [**revert_instance_to_snapshot**](docs/InstanceApi.md#revert_instance_to_snapshot) | **POST** /instance/{instance_id}:revert-snapshot | Revert a snapshot for an instance
...
*KmsKeyApi* | [**cancel_kms_key_deletion**](docs/KmsKeyApi.md#cancel_kms_key_deletion) | **POST** /kms-key/{id}/cancel-deletion | Cancel KMS Key Deletion
*KmsKeyApi* | [**create_kms_key**](docs/KmsKeyApi.md#create_kms_key) | **POST** /kms-key | Create KMS Key
*KmsKeyApi* | [**disable_kms_key**](docs/KmsKeyApi.md#disable_kms_key) | **POST** /kms-key/{id}/disable | Disable KMS Key
*KmsKeyApi* | [**disable_kms_key_rotation**](docs/KmsKeyApi.md#disable_kms_key_rotation) | **POST** /kms-key/{id}/disable-key-rotation | Disable Key Rotation
*KmsKeyApi* | [**enable_kms_key**](docs/KmsKeyApi.md#enable_kms_key) | **POST** /kms-key/{id}/enable | Enable KMS Key
*KmsKeyApi* | [**enable_kms_key_rotation**](docs/KmsKeyApi.md#enable_kms_key_rotation) | **POST** /kms-key/{id}/enable-key-rotation | Enable Key Rotation
*KmsKeyApi* | [**get_kms_key**](docs/KmsKeyApi.md#get_kms_key) | **GET** /kms-key/{id} | Get KMS Key
*KmsKeyApi* | [**list_kms_key_rotations**](docs/KmsKeyApi.md#list_kms_key_rotations) | **GET** /kms-key/{id}/list-key-rotations | List KMS Key Rotations
*KmsKeyApi* | [**list_kms_keys**](docs/KmsKeyApi.md#list_kms_keys) | **GET** /kms-key | List KMS Keys
*KmsKeyApi* | [**replicate_kms_key**](docs/KmsKeyApi.md#replicate_kms_key) | **POST** /kms-key/{id}/replicate | Replicate KMS Key
*KmsKeyApi* | [**rotate_kms_key**](docs/KmsKeyApi.md#rotate_kms_key) | **POST** /kms-key/{id}/rotate | Rotate Key
*KmsKeyApi* | [**schedule_kms_key_deletion**](docs/KmsKeyApi.md#schedule_kms_key_deletion) | **POST** /kms-key/{id}/schedule-deletion | Schedule KMS Key Deletion
*ModelApi* | [**create_model**](docs/ModelApi.md#create_model) | **POST** /ai/model | Create Model
*ModelApi* | [**delete_model**](docs/ModelApi.md#delete_model) | **DELETE** /ai/model/{id} | Delete Model
*ModelApi* | [**get_model**](docs/ModelApi.md#get_model) | **GET** /ai/model/{id} | Get Model
*ModelApi* | [**list_models**](docs/ModelApi.md#list_models) | **GET** /ai/model | List Models
...
*NetworkLoadBalancerApi* | [**delete_load_balancer_service**](docs/NetworkLoadBalancerApi.md#delete_load_balancer_service) | **DELETE** /load-balancer/{id}/service/{service_id} | Delete a Load Balancer Service
...
*NetworkLoadBalancerApi* | [**get_load_balancer_service**](docs/NetworkLoadBalancerApi.md#get_load_balancer_service) | **GET** /load-balancer/{id}/service/{service_id} | Retrieve Load Balancer Service details
...
*NetworkLoadBalancerApi* | [**reset_load_balancer_service_field**](docs/NetworkLoadBalancerApi.md#reset_load_balancer_service_field) | **DELETE** /load-balancer/{id}/service/{service_id}/{field} | Reset a Load Balancer Service field to its default value
...
*NetworkLoadBalancerApi* | [**update_load_balancer_service**](docs/NetworkLoadBalancerApi.md#update_load_balancer_service) | **PUT** /load-balancer/{id}/service/{service_id} | Update a Load Balancer Service
*NodepoolApi* | [**create_sks_nodepool**](docs/NodepoolApi.md#create_sks_nodepool) | **POST** /sks-cluster/{id}/nodepool | Create a new SKS Nodepool
*NodepoolApi* | [**delete_sks_nodepool**](docs/NodepoolApi.md#delete_sks_nodepool) | **DELETE** /sks-cluster/{id}/nodepool/{sks_nodepool_id} | Delete an SKS Nodepool
*NodepoolApi* | [**evict_sks_nodepool_members**](docs/NodepoolApi.md#evict_sks_nodepool_members) | **PUT** /sks-cluster/{id}/nodepool/{sks_nodepool_id}:evict | Evict Nodepool members
*NodepoolApi* | [**get_sks_nodepool**](docs/NodepoolApi.md#get_sks_nodepool) | **GET** /sks-cluster/{id}/nodepool/{sks_nodepool_id} | Retrieve SKS Nodepool details
*NodepoolApi* | [**scale_sks_nodepool**](docs/NodepoolApi.md#scale_sks_nodepool) | **PUT** /sks-cluster/{id}/nodepool/{sks_nodepool_id}:scale | Scale a SKS Nodepool
*NodepoolApi* | [**update_sks_nodepool**](docs/NodepoolApi.md#update_sks_nodepool) | **PUT** /sks-cluster/{id}/nodepool/{sks_nodepool_id} | Update an SKS Nodepool
...
*OrganizationPolicyApi* | [**reset_iam_organization_policy**](docs/OrganizationPolicyApi.md#reset_iam_organization_policy) | **POST** /iam-organization-policy:reset | Reset IAM Organization Policy
*OrganizationPolicyApi* | [**update_iam_organization_policy**](docs/OrganizationPolicyApi.md#update_iam_organization_policy) | **PUT** /iam-organization-policy | Update IAM Organization Policy
...
*RecordApi* | [**create_dns_domain_record**](docs/RecordApi.md#create_dns_domain_record) | **POST** /dns-domain/{domain_id}/record | Create DNS domain record
*RecordApi* | [**delete_dns_domain_record**](docs/RecordApi.md#delete_dns_domain_record) | **DELETE** /dns-domain/{domain_id}/record/{record_id} | Delete DNS domain record
*RecordApi* | [**get_dns_domain_record**](docs/RecordApi.md#get_dns_domain_record) | **GET** /dns-domain/{domain_id}/record/{record_id} | Retrieve DNS domain record details
*RecordApi* | [**list_dns_domain_records**](docs/RecordApi.md#list_dns_domain_records) | **GET** /dns-domain/{domain_id}/record | List DNS domain records
*RecordApi* | [**update_dns_domain_record**](docs/RecordApi.md#update_dns_domain_record) | **PUT** /dns-domain/{domain_id}/record/{record_id} | Update DNS domain record
...
*SecurityGroupApi* | [**delete_rule_from_security_group**](docs/SecurityGroupApi.md#delete_rule_from_security_group) | **DELETE** /security-group/{id}/rules/{rule_id} | Delete a Security Group rule
...
*VpcManagementApi* | [**create_vpc**](docs/VpcManagementApi.md#create_vpc) | **POST** /vpc | [BETA] Create a VPC
*VpcManagementApi* | [**delete_vpc**](docs/VpcManagementApi.md#delete_vpc) | **DELETE** /vpc/{id} | [BETA] Delete a VPC
*VpcManagementApi* | [**get_vpc**](docs/VpcManagementApi.md#get_vpc) | **GET** /vpc/{id} | [BETA] Retrieve VPC details
*VpcManagementApi* | [**list_vpcs**](docs/VpcManagementApi.md#list_vpcs) | **GET** /vpc | [BETA] List VPCs
*VpcManagementApi* | [**update_vpc**](docs/VpcManagementApi.md#update_vpc) | **PUT** /vpc/{id} | [BETA] Update a VPC
*VpcRouteApi* | [**create_route**](docs/VpcRouteApi.md#create_route) | **POST** /vpc/{vpc_id}/subnet/{subnet_id}/route | [BETA] Create a route
*VpcRouteApi* | [**delete_route**](docs/VpcRouteApi.md#delete_route) | **DELETE** /vpc/{vpc_id}/subnet/{subnet_id}/route/{id} | [BETA] Delete a route
*VpcRouteApi* | [**list_routes**](docs/VpcRouteApi.md#list_routes) | **GET** /vpc/{vpc_id}/subnet/{subnet_id}/route | [BETA] List Subnet routes
*VpcRouteApi* | [**list_vpc_routes**](docs/VpcRouteApi.md#list_vpc_routes) | **GET** /vpc/{vpc_id}/route | [BETA] List VPC routes
*VpcSubnetApi* | [**attach_instance_to_subnet**](docs/VpcSubnetApi.md#attach_instance_to_subnet) | **PUT** /vpc/{vpc_id}/subnet/{subnet_id}/attach | [BETA] Attach a Compute instance to a Subnet
*VpcSubnetApi* | [**create_subnet**](docs/VpcSubnetApi.md#create_subnet) | **POST** /vpc/{vpc_id}/subnet | [BETA] Create a Subnet
*VpcSubnetApi* | [**delete_subnet**](docs/VpcSubnetApi.md#delete_subnet) | **DELETE** /vpc/{vpc_id}/subnet/{id} | [BETA] Delete a Subnet
*VpcSubnetApi* | [**detach_instance_from_subnet**](docs/VpcSubnetApi.md#detach_instance_from_subnet) | **PUT** /vpc/{vpc_id}/subnet/{subnet_id}/detach | [BETA] Detach a Compute instance from a Subnet
*VpcSubnetApi* | [**get_subnet**](docs/VpcSubnetApi.md#get_subnet) | **GET** /vpc/{vpc_id}/subnet/{id} | [BETA] Retrieve Subnet details
*VpcSubnetApi* | [**list_subnets**](docs/VpcSubnetApi.md#list_subnets) | **GET** /vpc/{vpc_id}/subnet | [BETA] List Subnets
*VpcSubnetApi* | [**update_subnet**](docs/VpcSubnetApi.md#update_subnet) | **PUT** /vpc/{vpc_id}/subnet/{id} | [BETA] Update a Subnet
...
## Documentation For Models
 ...
 - [AttachInstanceToSubnetRequest](docs/AttachInstanceToSubnetRequest.md)
 ...
 - [BlockStorageSnapshotRef](docs/BlockStorageSnapshotRef.md)
 - [BlockStorageVolume](docs/BlockStorageVolume.md)
 - [BlockStorageVolumeRef](docs/BlockStorageVolumeRef.md)
 - [ClickHouseServerSettings](docs/ClickHouseServerSettings.md)
 ...
 - [CreateDbaasClickhouseUserRequest](docs/CreateDbaasClickhouseUserRequest.md)
 ...
 - [CreateDbaasServiceClickhouseRequest](docs/CreateDbaasServiceClickhouseRequest.md)
 ...
 - [DbaasClickhouseAclConfig](docs/DbaasClickhouseAclConfig.md)
 - [DbaasClickhouseGrantedRole](docs/DbaasClickhouseGrantedRole.md)
 - [DbaasClickhouseRole](docs/DbaasClickhouseRole.md)
 - [DbaasClickhouseRolePrivilege](docs/DbaasClickhouseRolePrivilege.md)
 - [DbaasClickhouseRoles](docs/DbaasClickhouseRoles.md)
 - [DbaasClickhouseUser](docs/DbaasClickhouseUser.md)
 - [DbaasClickhouseUserAclConfig](docs/DbaasClickhouseUserAclConfig.md)
 - [DbaasClickhouseUserPrivilege](docs/DbaasClickhouseUserPrivilege.md)
 - [DbaasClickhouseUserRole](docs/DbaasClickhouseUserRole.md)
 - [DbaasClickhouseUserRoleInput](docs/DbaasClickhouseUserRoleInput.md)
 - [DbaasClickhouseUsers](docs/DbaasClickhouseUsers.md)
 ...
 - [DbaasServiceClickhouse](docs/DbaasServiceClickhouse.md)
 - [DbaasServiceClickhouseComponentsInner](docs/DbaasServiceClickhouseComponentsInner.md)
 - [DbaasServiceClickhouseConnectionInfo](docs/DbaasServiceClickhouseConnectionInfo.md)
 - [DbaasServiceClickhousePrometheusUri](docs/DbaasServiceClickhousePrometheusUri.md)
 ...
 - [DbaasServiceThanosUsersInner](docs/DbaasServiceThanosUsersInner.md)
 ...
 - [DbaasUserClickhouseSecrets](docs/DbaasUserClickhouseSecrets.md)
 ...
 - [EnvImpactDetail](docs/EnvImpactDetail.md)
 - [EnvImpactIndicator](docs/EnvImpactIndicator.md)
 - [EnvImpactReport](docs/EnvImpactReport.md)
 ...
 - [GetDbaasSettingsClickhouse200Response](docs/GetDbaasSettingsClickhouse200Response.md)
 - [GetDbaasSettingsClickhouse200ResponseSettings](docs/GetDbaasSettingsClickhouse200ResponseSettings.md)
 - [GetDbaasSettingsClickhouse200ResponseSettingsClickhouse](docs/GetDbaasSettingsClickhouse200ResponseSettingsClickhouse.md)
 ...
 - [GetDbaasSettingsThanos200Response](docs/GetDbaasSettingsThanos200Response.md)
 - [GetDbaasSettingsThanos200ResponseSettings](docs/GetDbaasSettingsThanos200ResponseSettings.md)
 - [GetDbaasSettingsThanos200ResponseSettingsThanos](docs/GetDbaasSettingsThanos200ResponseSettingsThanos.md)
 ...
 - [GetDeploymentLogsEntry](docs/GetDeploymentLogsEntry.md)
 - [GetDeploymentLogsResponse](docs/GetDeploymentLogsResponse.md)
 ...
 - [GetImpactEstimate200Response](docs/GetImpactEstimate200Response.md)
 - [GetImpactEstimateRequest](docs/GetImpactEstimateRequest.md)
 ...
 - [ImpactBreakdown](docs/ImpactBreakdown.md)
 - [ImpactErrorResponse](docs/ImpactErrorResponse.md)
 - [ImpactResourceTreeNode](docs/ImpactResourceTreeNode.md)
 - [ImpactValueWithUnit](docs/ImpactValueWithUnit.md)
 ...
 - [InstancePoolRef](docs/InstancePoolRef.md)
 ...
 - [JsonSchemaClickhouse](docs/JsonSchemaClickhouse.md)
 ...
 - [ListDeploymentsResponseEntry](docs/ListDeploymentsResponseEntry.md)
 ...
 - [ListRouteEntry](docs/ListRouteEntry.md)
 ...
 - [ListSubnetEntry](docs/ListSubnetEntry.md)
 ...
 - [ListVpcEntry](docs/ListVpcEntry.md)
 - [ListVpcRoutes200Response](docs/ListVpcRoutes200Response.md)
 ...
 - [NvidiaMigProfileA3024gb](docs/NvidiaMigProfileA3024gb.md)
 - [NvidiaMigProfileB300269gb](docs/NvidiaMigProfileB300269gb.md)
 - [NvidiaMigProfileRtxpro600096gb](docs/NvidiaMigProfileRtxpro600096gb.md)
 - [NvidiaMigProfiles](docs/NvidiaMigProfiles.md)
 ...
 - [PrivateNetworkRef](docs/PrivateNetworkRef.md)
 ...
 - [RecomputeBundleResponse](docs/RecomputeBundleResponse.md)
 ...
 - [ScheduleKmsKeyDeletionResponse](docs/ScheduleKmsKeyDeletionResponse.md)
 ...
 - [SecurityGroupRef](docs/SecurityGroupRef.md)
 ...
 - [SksClusterRef](docs/SksClusterRef.md)
 ...
 - [SubnetInstancesInner](docs/SubnetInstancesInner.md)
 ...
 - [UpdateDbaasServiceClickhouseRequest](docs/UpdateDbaasServiceClickhouseRequest.md)
