...
For more information, please visit [https://exoscale.com](https://portal.exoscale.com/tickets)
...
*DbaasApi* | [**get_dbaas_service_type**](docs/DbaasApi.md#get_dbaas_service_type) | **GET** /dbaas-service-type/{service-type_name} | Get a DBaaS service type
...
*IamApi* | [**create_access_key**](docs/IamApi.md#create_access_key) | **POST** /access-key | Create a legacy IAM Access Key
