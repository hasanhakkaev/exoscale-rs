...
*DbaasApi* | [**delete_dbaas_clickhouse_user**](docs/DbaasApi.md#delete_dbaas_clickhouse_user) | **DELETE** /dbaas-clickhouse/{service_name}/user/{username} | [BETA] Delete a DBaaS ClickHouse user
...
*VpcApi* | [**attach_instance_to_subnet**](docs/VpcApi.md#attach_instance_to_subnet) | **PUT** /vpc/{vpc_id}/subnet/{subnet_id}/attach | [BETA] Attach a Compute instance to a Subnet
*VpcApi* | [**create_route**](docs/VpcApi.md#create_route) | **POST** /vpc/{vpc_id}/subnet/{subnet_id}/route | [BETA] Create a route
*VpcApi* | [**create_subnet**](docs/VpcApi.md#create_subnet) | **POST** /vpc/{vpc_id}/subnet | [BETA] Create a Subnet
*VpcApi* | [**create_vpc**](docs/VpcApi.md#create_vpc) | **POST** /vpc | [BETA] Create a VPC
*VpcApi* | [**delete_route**](docs/VpcApi.md#delete_route) | **DELETE** /vpc/{vpc_id}/subnet/{subnet_id}/route/{id} | [BETA] Delete a route
*VpcApi* | [**delete_subnet**](docs/VpcApi.md#delete_subnet) | **DELETE** /vpc/{vpc_id}/subnet/{id} | [BETA] Delete a Subnet
*VpcApi* | [**delete_vpc**](docs/VpcApi.md#delete_vpc) | **DELETE** /vpc/{id} | [BETA] Delete a VPC
*VpcApi* | [**detach_instance_from_subnet**](docs/VpcApi.md#detach_instance_from_subnet) | **PUT** /vpc/{vpc_id}/subnet/{subnet_id}/detach | [BETA] Detach a Compute instance from a Subnet
*VpcApi* | [**get_subnet**](docs/VpcApi.md#get_subnet) | **GET** /vpc/{vpc_id}/subnet/{id} | [BETA] Retrieve Subnet details
*VpcApi* | [**get_vpc**](docs/VpcApi.md#get_vpc) | **GET** /vpc/{id} | [BETA] Retrieve VPC details
*VpcApi* | [**list_routes**](docs/VpcApi.md#list_routes) | **GET** /vpc/{vpc_id}/subnet/{subnet_id}/route | [BETA] List Subnet routes
*VpcApi* | [**list_subnets**](docs/VpcApi.md#list_subnets) | **GET** /vpc/{vpc_id}/subnet | [BETA] List Subnets
*VpcApi* | [**list_vpc_routes**](docs/VpcApi.md#list_vpc_routes) | **GET** /vpc/{vpc_id}/route | [BETA] List VPC routes
*VpcApi* | [**list_vpcs**](docs/VpcApi.md#list_vpcs) | **GET** /vpc | [BETA] List VPCs
*VpcApi* | [**update_subnet**](docs/VpcApi.md#update_subnet) | **PUT** /vpc/{vpc_id}/subnet/{id} | [BETA] Update a Subnet
...
## Documentation For Models
 ...
 - [InstancePoolErrorReason](docs/InstancePoolErrorReason.md)
...
Generated with latest changes from 2026-07-01
