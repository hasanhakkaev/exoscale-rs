...
**instance** | Option<[**models::InstanceRef**](InstanceRef.md)> |  | [optional]
**name** | Option<**String**> | Volume name | [optional]
**state** | Option<**State**> | Volume state (enum: snapshotting, deleted, creating, detached, deleting, attaching, error, attached, detaching) | [optional][readonly]
