...
**cookie_samesite** | Option<**CookieSamesite**> |  (enum: lax, strict, none) | [optional]
...
**auth_azuread** | Option<[**models::AzureAdOAuthIntegration**](AzureADOAuthIntegration.md)> |  | [optional]
...
**auth_github** | Option<[**models::GithubAuthIntegration**](GithubAuthIntegration.md)> |  | [optional]
...
**smtp_server** | Option<[**models::SmtpServerSettings**](SMTPServerSettings.md)> |  | [optional]
**auth_gitlab** | Option<[**models::GitLabAuthIntegration**](GitLabAuthIntegration.md)> |  | [optional]
**alerting_nodata_or_nullvalues** | Option<**AlertingNodataOrNullvalues**> |  (enum: alerting, no_data, keep_state, ok) | [optional]
**auth_basic_enabled** | Option<**bool**> |  | [optional]
**date_formats** | Option<[**models::GrafanaDateFormatSpecifications**](GrafanaDateFormatSpecifications.md)> |  | [optional]
...
**user_auto_assign_org_role** | Option<**UserAutoAssignOrgRole**> |  (enum: Viewer, Admin, Editor) | [optional]
...
**auth_google** | Option<[**models::GoogleAuthIntegration**](GoogleAuthIntegration.md)> |  | [optional]
**oauth_allow_insecure_email_lookup** | Option<**bool**> |  | [optional]
**alerting_max_annotations_to_keep** | Option<**u32**> |  | [optional]
**auth_generic_oauth** | Option<[**models::GenericOAuthIntegration**](GenericOAuthIntegration.md)> |  | [optional]
**custom_domain** | Option<**String**> | Serve the web frontend using a custom CNAME pointing to the Aiven DNS name | [optional]
**alerting_error_or_timeout** | Option<**AlertingErrorOrTimeout**> |  (enum: alerting, keep_state) | [optional]
