...
**authentication_backend** | Option<**AuthenticationBackend**> | The internal backend. Enter `internal` (enum: internal) | [optional]
...
**r#type** | Option<**Type**> | The type of rate limiting (enum: username) | [optional]
