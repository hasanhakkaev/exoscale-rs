...
**group_max_session_timeout_ms** | Option<**u32**> | The maximum allowed session timeout for registered consumers. Longer timeouts give consumers more time to process messages in between heartbeats at the cost of a longer time to detect failures. | [optional]
**log_flush_interval_messages** | Option<**u64**> | The number of messages accumulated on a log partition before messages are flushed to disk | [optional]
...
**max_connections_per_ip** | Option<**u32**> | The maximum number of connections allowed from each ip address (defaults to 2147483647). | [optional]
...
**log_index_size_max_bytes** | Option<**u32**> | The maximum size in bytes of the offset index | [optional]
**auto_create_topics_enable** | Option<**bool**> | Enable auto creation of topics | [optional]
**log_index_interval_bytes** | Option<**u32**> | The interval with which Kafka adds an entry to the offset index | [optional]
**replica_fetch_max_bytes** | Option<**u32**> | The number of bytes of messages to attempt to fetch for each partition (defaults to 1048576). This is not an absolute maximum, if the first record batch in the first non-empty partition of the fetch is larger than this value, the record batch will still be returned to ensure that progress can be made. | [optional]
**num_partitions** | Option<**u16**> | Number of partitions for autocreated topics | [optional]
**transaction_state_log_segment_bytes** | Option<**u32**> | The transaction topic segment bytes should be kept relatively small in order to facilitate faster log compaction and cache loads (defaults to 104857600 (100 mebibytes)). | [optional]
**replica_fetch_response_max_bytes** | Option<**u32**> | Maximum bytes expected for the entire fetch response (defaults to 10485760). Records are fetched in batches, and if the first record batch in the first non-empty partition of the fetch is larger than this value, the record batch will still be returned to ensure that progress can be made. As such, this is not an absolute maximum. | [optional]
**log_message_timestamp_type** | Option<**LogMessageTimestampType**> | Define whether the timestamp in the message is message create time or log append time. (enum: CreateTime, LogAppendTime) | [optional]
**connections_max_idle_ms** | Option<**u32**> | Idle connections timeout: the server socket processor threads close the connections that idle for longer than this. | [optional]
**log_flush_interval_ms** | Option<**u64**> | The maximum time in ms that a message in any topic is kept in memory before flushed to disk. If not set, the value in log.flush.scheduler.interval.ms is used | [optional]
**log_preallocate** | Option<**bool**> | Should pre allocate file when create new segment? | [optional]
**log_segment_delete_delay_ms** | Option<**u32**> | The amount of time to wait before deleting a file from the filesystem | [optional]
**message_max_bytes** | Option<**u32**> | The maximum size of message that the server can receive. | [optional]
...
**log_local_retention_bytes** | Option<**i64**> | The maximum size of local log segments that can grow for a partition before it gets eligible for deletion. If set to -2, the value of log.retention.bytes is used. The effective value should always be less than or equal to log.retention.bytes value. | [optional]
**log_roll_jitter_ms** | Option<**u64**> | The maximum jitter to subtract from logRollTimeMillis (in milliseconds). If not set, the value in log.roll.jitter.hours is used | [optional]
...
**compression_type** | Option<**CompressionType**> | Specify the final compression type for a given topic. This configuration accepts the standard compression codecs ('gzip', 'snappy', 'lz4', 'zstd'). It additionally accepts 'uncompressed' which is equivalent to no compression; and 'producer' which means retain the original compression codec set by the producer. (enum: gzip, snappy, lz4, zstd, uncompressed, producer) | [optional]
...
**log_cleanup_and_compaction** | Option<[**models::ConfigureLogCleanerForTopicCompaction**](ConfigureLogCleanerForTopicCompaction.md)> |  | [optional]
