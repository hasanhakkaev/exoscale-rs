...
**r#type** | Option<**Type**> | DNS domain record type (enum: NS, CAA, NAPTR, POOL, A, HINFO, CNAME, SOA, SSHFP, SRV, AAAA, MX, TXT, ALIAS, URL, SPF) | [optional]
**ttl** | Option<**u64**> | DNS domain record TTL | [optional]
**priority** | Option<**u64**> | DNS domain record priority | [optional]
**id** | Option<**uuid::Uuid**> | DNS domain record ID | [optional][readonly]
