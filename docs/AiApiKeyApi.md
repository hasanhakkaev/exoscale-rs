...
------------- | ------------- | -------------
[**create_ai_api_key**](AiApiKeyApi.md#create_ai_api_key) | **POST** /ai/api-key | [BETA] Create AI API Key
[**delete_ai_api_key**](AiApiKeyApi.md#delete_ai_api_key) | **DELETE** /ai/api-key/{id} | [BETA] Delete AI API Key
[**get_ai_api_key**](AiApiKeyApi.md#get_ai_api_key) | **GET** /ai/api-key/{id} | [BETA] Get AI API Key
[**get_user_org_consumption_quota**](AiApiKeyApi.md#get_user_org_consumption_quota) | **GET** /ai/quota | [BETA] Get Organization Consumption Quota
[**list_ai_api_keys**](AiApiKeyApi.md#list_ai_api_keys) | **GET** /ai/api-key | [BETA] List AI API Keys
[**reveal_ai_api_key**](AiApiKeyApi.md#reveal_ai_api_key) | **GET** /ai/api-key/{id}/reveal | [BETA] Reveal AI API Key
[**rotate_ai_api_key**](AiApiKeyApi.md#rotate_ai_api_key) | **POST** /ai/api-key/{id}/rotate | [BETA] Rotate AI API Key
[**update_ai_api_key**](AiApiKeyApi.md#update_ai_api_key) | **PATCH** /ai/api-key/{id} | [BETA] Update AI API Key
