...
------------ | ------------- | ------------- | -------------
**authentication_methods** | Option<[**models::UpdateDbaasServiceKafkaRequestAuthenticationMethods**](UpdateDbaasServiceKafkaRequestAuthenticationMethods.md)> |  | [optional]
