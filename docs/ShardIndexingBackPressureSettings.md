...
------------ | ------------- | ------------- | -------------
**primary_parameter** | Option<[**models::PrimaryParameter**](PrimaryParameter.md)> |  | [optional]
**operating_factor** | Option<[**models::OperatingFactor**](OperatingFactor.md)> |  | [optional]
