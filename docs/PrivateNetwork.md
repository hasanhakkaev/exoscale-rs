...
**leases** | Option<[**Vec<models::PrivateNetworkLease>**](PrivateNetworkLease.md)> | Private Network leased IP addresses | [optional][readonly]
**id** | Option<**uuid::Uuid**> | Private Network ID | [optional][readonly]
**vni** | Option<**u64**> | Private Network VXLAN ID | [optional]
**netmask** | Option<**String**> | Private Network netmask | [optional]
**options** | Option<[**models::PrivateNetworkOptions**](PrivateNetworkOptions.md)> |  | [optional]
