...
[**list_sks_cluster_deprecated_resources**](ClusterApi.md#list_sks_cluster_deprecated_resources) | **GET** /sks-cluster-deprecated-resources/{id} | Resources that are scheduled to be removed in future kubernetes releases
[**list_sks_cluster_versions**](ClusterApi.md#list_sks_cluster_versions) | **GET** /sks-cluster-version | List available versions for SKS clusters
[**list_sks_clusters**](ClusterApi.md#list_sks_clusters) | **GET** /sks-cluster | List SKS clusters
[**rotate_sks_ccm_credentials**](ClusterApi.md#rotate_sks_ccm_credentials) | **PUT** /sks-cluster/{id}/rotate-ccm-credentials | Rotate Exoscale CCM credentials
[**rotate_sks_csi_credentials**](ClusterApi.md#rotate_sks_csi_credentials) | **PUT** /sks-cluster/{id}/rotate-csi-credentials | Rotate Exoscale CSI credentials
[**rotate_sks_karpenter_credentials**](ClusterApi.md#rotate_sks_karpenter_credentials) | **PUT** /sks-cluster/{id}/rotate-karpenter-credentials | Rotate Exoscale Karpenter credentials
[**rotate_sks_operators_ca**](ClusterApi.md#rotate_sks_operators_ca) | **PUT** /sks-cluster/{id}/rotate-operators-ca | Rotate operators certificate authority
[**update_sks_cluster**](ClusterApi.md#update_sks_cluster) | **PUT** /sks-cluster/{id} | Update an SKS cluster
[**upgrade_sks_cluster**](ClusterApi.md#upgrade_sks_cluster) | **PUT** /sks-cluster/{id}/upgrade | Upgrade an SKS cluster
[**upgrade_sks_cluster_service_level**](ClusterApi.md#upgrade_sks_cluster_service_level) | **PUT** /sks-cluster/{id}/upgrade-service-level | Upgrade a SKS cluster to pro
...
> models::Operation rotate_sks_karpenter_credentials(id)
