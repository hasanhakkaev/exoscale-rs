...
**state** | Option<**State**> | Instance Pool state (enum: scaling-up, scaling-down, destroying, creating, suspended, running, updating, error) | [optional][readonly]
...
**error_reason** | Option<[**models::InstancePoolErrorReason**](InstancePoolErrorReason.md)> |  | [optional]
