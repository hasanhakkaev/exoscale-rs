...
------------ | ------------- | ------------- | -------------
**application_consistent_snapshot_enabled** | Option<**bool**> | Template with Qemu Guest Agent installed for application consistent snapshot | [optional]
...
**id** | Option<**uuid::Uuid**> | Template ID | [optional][readonly]
**zones** | Option<[**Vec<models::ZoneName>**](ZoneName.md)> | Zones availability | [optional]
...
**visibility** | Option<**Visibility**> | Template visibility (enum: private, public) | [optional][readonly]
