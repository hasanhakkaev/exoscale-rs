...
**connection_info** | Option<[**models::DbaasServicePgConnectionInfo**](DbaasServicePgConnectionInfo.md)> |  | [optional]
...
**name** | **String** |  | 
**connection_pools** | Option<[**Vec<models::DbaasServicePgConnectionPoolsInner>**](DbaasServicePgConnectionPoolsInner.md)> | PostgreSQL PGBouncer connection pools | [optional]
**r#type** | **String** |  | 
...
**users** | Option<[**Vec<models::DbaasServicePgUsersInner>**](DbaasServicePgUsersInner.md)> | List of service users | [optional]
