...
pub struct JsonSchemaKafkaRest {
    ...
    #[serde(rename = "name_strategy_validation", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "consumer_enable_auto_commit", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "consumer_request_max_bytes", skip_serializing_if = "Option::is_none")]
    pub consumer_request_max_bytes: Option<u32>,
    ...
    #[serde(rename = "simpleconsumer_pool_size_max", skip_serializing_if = "Option::is_none")]
    pub simpleconsumer_pool_size_max: Option<u8>,
    ...
    #[serde(rename = "consumer_request_timeout_ms", skip_serializing_if = "Option::is_none")]
