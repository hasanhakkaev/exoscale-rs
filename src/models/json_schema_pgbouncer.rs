...
pub struct JsonSchemaPgbouncer {
    ...
    #[serde(
        rename = "ignore_startup_parameters",
    ...
    pub server_lifetime: Option<i32>,
    #[serde(rename = "autodb_pool_mode", skip_serializing_if = "Option::is_none")]
    pub autodb_pool_mode: Option<AutodbPoolMode>,
    #[serde(
        rename = "server_idle_timeout",
        skip_serializing_if = "Option::is_none"
    )]
    pub server_idle_timeout: Option<i32>,
    #[serde(
        rename = "autodb_max_db_connections",
        skip_serializing_if = "Option::is_none"
    )]
    pub autodb_max_db_connections: Option<i32>,
    #[serde(
        rename = "max_prepared_statements",
        skip_serializing_if = "Option::is_none"
    )]
    pub max_prepared_statements: Option<i32>,
    #[serde(
        rename = "server_reset_query_always",
        skip_serializing_if = "Option::is_none"
    )]
    pub server_reset_query_always: Option<bool>,
    #[serde(rename = "autodb_pool_size", skip_serializing_if = "Option::is_none")]
    pub autodb_pool_size: Option<i32>,
    #[serde(
        rename = "autodb_idle_timeout",
        skip_serializing_if = "Option::is_none"
    )]
    pub autodb_idle_timeout: Option<i32>,
}
