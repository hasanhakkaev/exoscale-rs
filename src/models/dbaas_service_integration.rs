...
pub struct DbaasServiceIntegration {
    ...
    #[serde(rename = "dest-endpoint_id", skip_serializing_if = "Option::is_none")]
    pub dest_endpoint_id: Option<String>,
    /// Integration ID
    #[serde(rename = "service-integration_id")]
    ...
    pub active: bool,
    /// Source endpoint ID
    #[serde(rename = "source-endpoint_id", skip_serializing_if = "Option::is_none")]
