...
pub struct JsonSchemaGrafana {
    ...
    #[serde(
        rename = "dashboard_previews_enabled",
    ...
    pub wal: Option<bool>,
    #[serde(
        rename = "unified_alerting_enabled",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "user_auto_assign_org",
        skip_serializing_if = "Option::is_none"
    )]
    pub user_auto_assign_org: Option<bool>,
    #[serde(
        rename = "dataproxy_send_user_header",
        skip_serializing_if = "Option::is_none"
    )]
    pub dataproxy_send_user_header: Option<bool>,
    #[serde(
        rename = "google_analytics_ua_id",
        skip_serializing_if = "Option::is_none"
    )]
    pub google_analytics_ua_id: Option<String>,
    #[serde(
        rename = "dashboards_versions_to_keep",
        skip_serializing_if = "Option::is_none"
    )]
    pub dashboards_versions_to_keep: Option<i32>,
    ...
    #[serde(
        rename = "alerting_nodata_or_nullvalues",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "user_auto_assign_org_role",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    pub dataproxy_timeout: Option<i32>,
    ...
    #[serde(
        rename = "dashboards_min_refresh_interval",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "oauth_allow_insecure_email_lookup",
        skip_serializing_if = "Option::is_none"
    )]
    pub oauth_allow_insecure_email_lookup: Option<bool>,
    #[serde(
        rename = "alerting_max_annotations_to_keep",
        skip_serializing_if = "Option::is_none"
    )]
    pub alerting_max_annotations_to_keep: Option<i32>,
    ...
    #[serde(
        rename = "alerting_error_or_timeout",
        skip_serializing_if = "Option::is_none"
    )]
