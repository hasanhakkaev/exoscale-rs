...
pub struct ListAiApiKeysResponseEntry {
...
impl ListAiApiKeysResponseEntry {
    /// AI API key list entry
    pub fn new(updated_at: String, name: String, scope: String, id: uuid::Uuid, org_uuid: uuid::Uuid, created_at: String) -> ListAiApiKeysResponseEntry {
