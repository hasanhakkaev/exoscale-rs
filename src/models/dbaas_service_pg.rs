...
pub struct DbaasServicePg {
    ...
    pub connection_info: Option<Box<models::DbaasServicePgConnectionInfo>>,
    #[serde(rename = "backup-schedule", skip_serializing_if = "Option::is_none")]
    pub backup_schedule: Option<Box<models::DbaasServiceMysqlBackupSchedule>>,
    ...
    pub connection_pools: Option<Vec<models::DbaasServicePgConnectionPoolsInner>>,
    #[serde(rename = "type")]
    pub r#type: String,
    ...
    pub users: Option<Vec<models::DbaasServicePgUsersInner>>,
}
