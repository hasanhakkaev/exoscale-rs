...
pub struct DbaasServiceClickhouse {
    ...
    pub connection_info: Option<Box<models::DbaasServiceClickhouseConnectionInfo>>,
    ...
    pub users: Option<Vec<models::DbaasClickhouseUser>>,
}

impl DbaasServiceClickhouse {
    pub fn new(prometheus_uri: models::DbaasServiceClickhousePrometheusUri, name: String, r#type: String, plan: String) -> DbaasServiceClickhouse {
