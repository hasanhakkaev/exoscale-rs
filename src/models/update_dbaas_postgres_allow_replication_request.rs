...
pub struct UpdateDbaasPostgresAllowReplicationRequest {
    #[serde(rename = "allow-replication", skip_serializing_if = "Option::is_none")]
    pub allow_replication: Option<bool>,
}

impl UpdateDbaasPostgresAllowReplicationRequest {
    pub fn new() -> UpdateDbaasPostgresAllowReplicationRequest {
