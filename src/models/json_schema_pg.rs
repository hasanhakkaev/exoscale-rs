...
pub struct JsonSchemaPg {
    ...
    #[serde(
        rename = "pg_stat_monitor.pgsm_enable_query_plan",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "pg_stat_monitor.pgsm_max_buckets",
        skip_serializing_if = "Option::is_none"
    )]
    pub pg_stat_monitor_period_pgsm_max_buckets: Option<i32>,
...
pub enum LogLinePrefix {
    ...
    PidEqualPercentPCommaUserEqualPercentUCommaDbEqualPercentDCommaAppEqualPercentACommaClientEqualPercentHQuote,
    #[serde(rename = "'%t [%p]: [%l-1] user=%u,db=%d,app=%a,client=%h '")]
    PercentTLeftSquareBracketPercentPRightSquareBracketColonLeftSquareBracketPercentL1RightSquareBracketUserEqualPercentUCommaDbEqualPercentDCommaAppEqualPercentACommaClientEqualPercentHQuote,
    #[serde(rename = "'%m [%p] %q[user=%u,db=%d,app=%a] '")]
    PercentMLeftSquareBracketPercentPRightSquareBracketPercentQLeftSquareBracketUserEqualPercentUCommaDbEqualPercentDCommaAppEqualPercentARightSquareBracketQuote,
}

impl Default for LogLinePrefix {
    fn default() -> LogLinePrefix {
        Self::PidEqualPercentPCommaUserEqualPercentUCommaDbEqualPercentDCommaAppEqualPercentACommaClientEqualPercentHQuote
    }
}
/// Record commit time of transactions.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
