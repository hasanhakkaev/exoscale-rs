...
pub struct DbaasServiceRedis {
    ...
    pub connection_info: Option<Box<models::DbaasServiceRedisConnectionInfo>>,
    ...
    pub components: Option<Vec<models::DbaasServiceRedisComponentsInner>>,
    ...
    pub users: Option<Vec<models::DbaasServiceRedisUsersInner>>,
}

impl DbaasServiceRedis {
    pub fn new(prometheus_uri: models::DbaasServiceMysqlPrometheusUri, name: String, r#type: String, plan: String) -> DbaasServiceRedis {
        DbaasServiceRedis {
            updated_at: None,
            node_count: None,
