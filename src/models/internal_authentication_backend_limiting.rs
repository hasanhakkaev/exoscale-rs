...
pub struct InternalAuthenticationBackendLimiting {
    /// The number of login attempts allowed before login is blocked
    #[serde(rename = "allowed_tries", skip_serializing_if = "Option::is_none")]
    pub allowed_tries: Option<u32>,
    /// The internal backend. Enter `internal`
    #[serde(rename = "authentication_backend", skip_serializing_if = "Option::is_none")]
    pub authentication_backend: Option<AuthenticationBackend>,
    /// The duration of time that login remains blocked after a failed login
    #[serde(rename = "block_expiry_seconds", skip_serializing_if = "Option::is_none")]
    pub block_expiry_seconds: Option<u32>,
...
impl InternalAuthenticationBackendLimiting {
    pub fn new() -> InternalAuthenticationBackendLimiting {
...
impl Default for AuthenticationBackend {
    fn default() -> AuthenticationBackend {
        Self::Internal
    }
}
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
