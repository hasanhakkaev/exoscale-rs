...
pub struct DbaasBackupConfig {
    ...
    #[serde(rename = "frequent-interval-minutes", skip_serializing_if = "Option::is_none")]
    pub frequent_interval_minutes: Option<u64>,
    /// Maximum age of the oldest frequent backup in service types supporting different backup schedules
    #[serde(rename = "frequent-oldest-age-minutes", skip_serializing_if = "Option::is_none")]
    pub frequent_oldest_age_minutes: Option<u64>,
    /// Interval of taking a frequent backup in service types supporting different backup schedules
    #[serde(rename = "infrequent-interval-minutes", skip_serializing_if = "Option::is_none")]
    pub infrequent_interval_minutes: Option<u64>,
    /// Maximum age of the oldest infrequent backup in service types supporting different backup schedules
    #[serde(rename = "infrequent-oldest-age-minutes", skip_serializing_if = "Option::is_none")]
    pub infrequent_oldest_age_minutes: Option<u64>,
}
