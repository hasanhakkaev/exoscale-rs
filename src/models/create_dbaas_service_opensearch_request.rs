...
pub struct CreateDbaasServiceOpensearchRequest {
    ...
    pub index_template: Option<Box<models::UpdateDbaasServiceOpensearchRequestIndexTemplate>>,
    #[serde(
    ...
    pub opensearch_dashboards:
        Option<Box<models::UpdateDbaasServiceOpensearchRequestOpensearchDashboards>>,
}

impl CreateDbaasServiceOpensearchRequest {
    pub fn new(plan: String) -> CreateDbaasServiceOpensearchRequest {
