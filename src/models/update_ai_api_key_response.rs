...
pub struct UpdateAiApiKeyResponse {
...
impl UpdateAiApiKeyResponse {
    /// Update AI API key response
    pub fn new(updated_at: String, name: String, scope: String, id: uuid::Uuid, org_uuid: uuid::Uuid, created_at: String) -> UpdateAiApiKeyResponse {
