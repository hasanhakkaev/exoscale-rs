...
pub struct DbaasEndpointElasticsearchInputCreateSettings {
...
impl DbaasEndpointElasticsearchInputCreateSettings {
    pub fn new(url: String, index_prefix: String) -> DbaasEndpointElasticsearchInputCreateSettings {
