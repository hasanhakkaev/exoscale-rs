...
impl DbaasServiceKafkaComponentsInner {
    pub fn new(component: String, host: String, port: i64, route: crate::models::EnumComponentRoute, usage: crate::models::EnumComponentUsage) -> DbaasServiceKafkaComponentsInner {
