...
pub struct JsonSchemaKafka {
    ...
    #[serde(
        rename = "sasl_oauthbearer_expected_audience",
    ...
    #[serde(
        rename = "sasl_oauthbearer_jwks_endpoint_url",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "sasl_oauthbearer_expected_issuer",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "log_local_retention_bytes",
        skip_serializing_if = "Option::is_none"
    )]
    pub log_local_retention_bytes: Option<i32>,
    ...
    #[serde(
        rename = "transaction_partition_verification_enable",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "log_local_retention_ms",
        skip_serializing_if = "Option::is_none"
    )]
    pub log_local_retention_ms: Option<i32>,
    ...
    #[serde(
        rename = "sasl_oauthbearer_sub_claim_name",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "log-cleanup-and-compaction",
        skip_serializing_if = "Option::is_none"
    )]
