...
impl AddServiceToLoadBalancerRequest {
    pub fn new(name: String, instance_pool: crate::models::InstancePool, protocol: Protocol, strategy: Strategy, port: i64, target_port: i64, healthcheck: crate::models::LoadBalancerServiceHealthcheck) -> AddServiceToLoadBalancerRequest {
