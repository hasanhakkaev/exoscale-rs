...
pub struct AddServiceToLoadBalancerRequest {
    ...
    pub instance_pool: Box<models::InstancePool>,
    ...
    pub healthcheck: Box<models::LoadBalancerServiceHealthcheck>,
}

impl AddServiceToLoadBalancerRequest {
    pub fn new(name: String, instance_pool: models::InstancePool, protocol: Protocol, strategy: Strategy, port: u64, target_port: u64, healthcheck: models::LoadBalancerServiceHealthcheck) -> AddServiceToLoadBalancerRequest {
