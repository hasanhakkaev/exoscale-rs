...
pub struct DbaasServiceKafka {
    ...
    #[serde(rename = "authentication-methods", skip_serializing_if = "Option::is_none")]
    pub authentication_methods: Option<Box<models::DbaasServiceKafkaAuthenticationMethods>>,
    ...
    pub connection_info: Option<Box<models::DbaasServiceKafkaConnectionInfo>>,
    ...
    #[serde(rename = "kafka-connect-enabled", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "schema-registry-settings", skip_serializing_if = "Option::is_none")]
    pub schema_registry_settings: Option<Box<models::JsonSchemaSchemaRegistry>>,
    /// List of backups for the service
    #[serde(rename = "backups", skip_serializing_if = "Option::is_none")]
    pub backups: Option<Vec<models::DbaasServiceBackup>>,
    #[serde(rename = "kafka-rest-settings", skip_serializing_if = "Option::is_none")]
    pub kafka_rest_settings: Option<Box<models::JsonSchemaKafkaRest>>,
    ...
    #[serde(rename = "kafka-connect-settings", skip_serializing_if = "Option::is_none")]
    pub kafka_connect_settings: Option<Box<models::JsonSchemaKafkaConnect>>,
    /// Service component information objects
    #[serde(rename = "components", skip_serializing_if = "Option::is_none")]
    pub components: Option<Vec<models::DbaasServiceKafkaComponentsInner>>,
    ...
    pub kafka_settings: Option<Box<models::JsonSchemaKafka>>,
    ...
    #[serde(rename = "schema-registry-enabled", skip_serializing_if = "Option::is_none")]
    ...
    pub users: Option<Vec<models::DbaasServiceKafkaUsersInner>>,
}
...
impl DbaasServiceKafka {
    pub fn new(prometheus_uri: models::DbaasServiceMysqlPrometheusUri, name: String, r#type: String, plan: String) -> DbaasServiceKafka {
        DbaasServiceKafka {
            ...
            prometheus_uri: Box::new(prometheus_uri),
            integrations: None,
            zone: None,
            node_states: None,
            name,
