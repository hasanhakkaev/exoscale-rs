...
pub struct GetDbaasSettingsThanos200ResponseSettingsThanos {
...
impl GetDbaasSettingsThanos200ResponseSettingsThanos {
    /// Thanos configuration values
    pub fn new() -> GetDbaasSettingsThanos200ResponseSettingsThanos {
