...
pub struct JsonSchemaRedis {
    ...
    pub lfu_log_factor: Option<i32>,
    #[serde(
        rename = "maxmemory_policy",
        default,
    ...
    pub lfu_decay_time: Option<i32>,
    /// Set output buffer limit for pub / sub clients in MB. The value is the hard limit, the soft limit is 1/4 of the hard limit. When setting the limit, be mindful of the available memory in the selected service plan.
    #[serde(
        rename = "pubsub_client_output_buffer_limit",
        skip_serializing_if = "Option::is_none"
    )]
    pub pubsub_client_output_buffer_limit: Option<i32>,
    #[serde(
        rename = "notify_keyspace_events",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "number_of_databases",
        skip_serializing_if = "Option::is_none"
    )]
    pub number_of_databases: Option<i32>,
}

impl JsonSchemaRedis {
    pub fn new() -> JsonSchemaRedis {
        JsonSchemaRedis {
            ssl: None,
            lfu_log_factor: None,
