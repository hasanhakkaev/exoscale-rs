...
pub async fn delete_snapshot(
    ...
    id: &str,
) -> Result<models::Operation, Error<DeleteSnapshotError>> {
...
pub async fn export_snapshot(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Operation, Error<ExportSnapshotError>> {
    let local_var_configuration = configuration;
...
pub async fn get_snapshot(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Snapshot, Error<GetSnapshotError>> {
    let local_var_configuration = configuration;
...
pub async fn list_snapshots(
    configuration: &configuration::Configuration,
) -> Result<models::ListSnapshots200Response, Error<ListSnapshotsError>> {
    let local_var_configuration = configuration;
