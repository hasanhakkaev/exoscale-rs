...
pub async fn delete_ssh_key(
    ...
    name: &str,
) -> Result<models::Operation, Error<DeleteSshKeyError>> {
...
pub async fn get_ssh_key(
    configuration: &configuration::Configuration,
    name: &str,
) -> Result<models::SshKey, Error<GetSshKeyError>> {
    let local_var_configuration = configuration;
...
pub async fn list_ssh_keys(
    configuration: &configuration::Configuration,
) -> Result<models::ListSshKeys200Response, Error<ListSshKeysError>> {
    let local_var_configuration = configuration;
...
pub async fn register_ssh_key(
    configuration: &configuration::Configuration,
    register_ssh_key_request: models::RegisterSshKeyRequest,
) -> Result<models::Operation, Error<RegisterSshKeyError>> {
    let local_var_configuration = configuration;
