...
pub async fn delete_reverse_dns_elastic_ip(
    ...
    id: &str,
) -> Result<models::Operation, Error<DeleteReverseDnsElasticIpError>> {
...
pub async fn delete_reverse_dns_instance(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Operation, Error<DeleteReverseDnsInstanceError>> {
    let local_var_configuration = configuration;
...
pub async fn get_reverse_dns_elastic_ip(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::ReverseDnsRecord, Error<GetReverseDnsElasticIpError>> {
    let local_var_configuration = configuration;
...
pub async fn get_reverse_dns_instance(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::ReverseDnsRecord, Error<GetReverseDnsInstanceError>> {
    let local_var_configuration = configuration;
...
pub async fn update_reverse_dns_elastic_ip(
    configuration: &configuration::Configuration,
    id: &str,
    update_reverse_dns_elastic_ip_request: models::UpdateReverseDnsElasticIpRequest,
) -> Result<models::Operation, Error<UpdateReverseDnsElasticIpError>> {
    let local_var_configuration = configuration;
...
pub async fn update_reverse_dns_instance(
    ...
    id: &str,
    update_reverse_dns_elastic_ip_request: models::UpdateReverseDnsElasticIpRequest,
) -> Result<models::Operation, Error<UpdateReverseDnsInstanceError>> {
    let local_var_configuration = configuration;
