...
pub async fn create_anti_affinity_group(
    ...
    create_anti_affinity_group_request: models::CreateAntiAffinityGroupRequest,
) -> Result<models::Operation, Error<CreateAntiAffinityGroupError>> {
...
pub async fn delete_anti_affinity_group(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Operation, Error<DeleteAntiAffinityGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn get_anti_affinity_group(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::AntiAffinityGroup, Error<GetAntiAffinityGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn list_anti_affinity_groups(
    configuration: &configuration::Configuration,
) -> Result<models::ListAntiAffinityGroups200Response, Error<ListAntiAffinityGroupsError>> {
    let local_var_configuration = configuration;
