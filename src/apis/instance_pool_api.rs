...
pub async fn create_instance_pool(
    ...
    create_instance_pool_request: models::CreateInstancePoolRequest,
) -> Result<models::Operation, Error<CreateInstancePoolError>> {
...
pub async fn delete_instance_pool(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Operation, Error<DeleteInstancePoolError>> {
    let local_var_configuration = configuration;
...
pub async fn evict_instance_pool_members(
    configuration: &configuration::Configuration,
    id: &str,
    evict_instance_pool_members_request: models::EvictInstancePoolMembersRequest,
) -> Result<models::Operation, Error<EvictInstancePoolMembersError>> {
    let local_var_configuration = configuration;
...
pub async fn get_instance_pool(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::InstancePool, Error<GetInstancePoolError>> {
    let local_var_configuration = configuration;
...
pub async fn list_instance_pools(
    configuration: &configuration::Configuration,
) -> Result<models::ListInstancePools200Response, Error<ListInstancePoolsError>> {
    let local_var_configuration = configuration;
...
pub async fn reset_instance_pool_field(
    ...
    id: &str,
    field: &str,
) -> Result<models::Operation, Error<ResetInstancePoolFieldError>> {
    let local_var_configuration = configuration;
...
pub async fn scale_instance_pool(
    configuration: &configuration::Configuration,
    id: &str,
    scale_instance_pool_request: models::ScaleInstancePoolRequest,
) -> Result<models::Operation, Error<ScaleInstancePoolError>> {
    let local_var_configuration = configuration;
...
pub async fn update_instance_pool(
    configuration: &configuration::Configuration,
    id: &str,
    update_instance_pool_request: models::UpdateInstancePoolRequest,
) -> Result<models::Operation, Error<UpdateInstancePoolError>> {
    let local_var_configuration = configuration;
