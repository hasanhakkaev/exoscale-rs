...
pub async fn attach_instance_to_private_network(
    ...
    id: &str,
    attach_instance_to_private_network_request: models::AttachInstanceToPrivateNetworkRequest,
) -> Result<models::Operation, Error<AttachInstanceToPrivateNetworkError>> {
...
pub async fn create_private_network(
    configuration: &configuration::Configuration,
    create_private_network_request: models::CreatePrivateNetworkRequest,
) -> Result<models::Operation, Error<CreatePrivateNetworkError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_private_network(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Operation, Error<DeletePrivateNetworkError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<DetachInstanceFromPrivateNetworkError>> {
    let local_var_configuration = configuration;
...
pub async fn get_private_network(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::PrivateNetwork, Error<GetPrivateNetworkError>> {
    let local_var_configuration = configuration;
...
pub async fn list_private_networks(
    configuration: &configuration::Configuration,
) -> Result<models::ListPrivateNetworks200Response, Error<ListPrivateNetworksError>> {
    let local_var_configuration = configuration;
...
pub async fn reset_private_network_field(
    ...
    id: &str,
    field: &str,
) -> Result<models::Operation, Error<ResetPrivateNetworkFieldError>> {
    let local_var_configuration = configuration;
...
pub async fn update_private_network(
    configuration: &configuration::Configuration,
    id: &str,
    update_private_network_request: models::UpdatePrivateNetworkRequest,
) -> Result<models::Operation, Error<UpdatePrivateNetworkError>> {
    let local_var_configuration = configuration;
...
pub async fn update_private_network_instance_ip(
    configuration: &configuration::Configuration,
    id: &str,
    update_private_network_instance_ip_request: models::UpdatePrivateNetworkInstanceIpRequest,
) -> Result<models::Operation, Error<UpdatePrivateNetworkInstanceIpError>> {
    let local_var_configuration = configuration;
