...
/// struct for typed errors of method [`create_dbaas_service_thanos`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateDbaasServiceThanosError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`delete_dbaas_clickhouse_role`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteDbaasClickhouseRoleError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`delete_dbaas_service_thanos`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteDbaasServiceThanosError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`get_dbaas_service_thanos`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetDbaasServiceThanosError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`get_dbaas_settings_thanos`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetDbaasSettingsThanosError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`list_dbaas_clickhouse_roles`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListDbaasClickhouseRolesError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`reveal_dbaas_thanos_user_password`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RevealDbaasThanosUserPasswordError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`start_dbaas_thanos_maintenance`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum StartDbaasThanosMaintenanceError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`update_dbaas_service_thanos`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateDbaasServiceThanosError {
    UnknownValue(serde_json::Value),
}
...
pub async fn create_dbaas_clickhouse_user(configuration: &configuration::Configuration, service_name: &str, create_dbaas_clickhouse_user_request: models::CreateDbaasClickhouseUserRequest) -> Result<models::DbaasUserClickhouseSecrets, Error<CreateDbaasClickhouseUserError>> {
...
pub async fn create_dbaas_service_thanos(configuration: &configuration::Configuration, name: &str, create_dbaas_service_thanos_request: models::CreateDbaasServiceThanosRequest) -> Result<models::Operation, Error<CreateDbaasServiceThanosError>> {
    let local_var_name = name;
    let local_var_create_dbaas_service_thanos_request = create_dbaas_service_thanos_request;
    ...
    let query_params_vec: Vec<(&str, String)> = Vec::new();
    let query_params_option = if query_params_vec.is_empty() { None } else { Some(query_params_vec.as_slice())};
            let body_payload_option = Some(local_var_create_dbaas_service_thanos_request);
...
pub async fn delete_dbaas_clickhouse_role(configuration: &configuration::Configuration, service_name: &str, role_uuid: String) -> Result<models::Operation, Error<DeleteDbaasClickhouseRoleError>> {
    let local_var_service_name = service_name;
    let local_var_role_uuid = role_uuid;

    let mut path_params_map = std::collections::HashMap::new();
                path_params_map.insert("service_name".to_string(), crate::apis::urlencode(local_var_service_name));
                path_params_map.insert("role_uuid".to_string(), crate::apis::urlencode(local_var_role_uuid));
    ...
    "/dbaas-clickhouse/{service_name}/role/{role_uuid}",
    path_params_map,
    query_params_option,
    body_payload_option,
    ).await
}
pub async fn delete_dbaas_clickhouse_user(configuration: &configuration::Configuration, service_name: &str, user_uuid: String) -> Result<models::Operation, Error<DeleteDbaasClickhouseUserError>> {
    let local_var_service_name = service_name;
    let local_var_user_uuid = user_uuid;

    let mut path_params_map = std::collections::HashMap::new();
                path_params_map.insert("service_name".to_string(), crate::apis::urlencode(local_var_service_name));
                path_params_map.insert("user_uuid".to_string(), crate::apis::urlencode(local_var_user_uuid));
    ...
    configuration,
    reqwest::Method::DELETE,
    "/dbaas-clickhouse/{service_name}/user/{user_uuid}",
    path_params_map,
    query_params_option,
    body_payload_option,
    ).await
...
pub async fn delete_dbaas_service_thanos(configuration: &configuration::Configuration, name: &str) -> Result<models::Operation, Error<DeleteDbaasServiceThanosError>> {
    let local_var_name = name;
...
pub async fn get_dbaas_service_thanos(configuration: &configuration::Configuration, name: &str) -> Result<models::DbaasServiceThanos, Error<GetDbaasServiceThanosError>> {
    let local_var_name = name;
...
pub async fn get_dbaas_settings_thanos(configuration: &configuration::Configuration, ) -> Result<models::GetDbaasSettingsThanos200Response, Error<GetDbaasSettingsThanosError>> {
...
pub async fn list_dbaas_clickhouse_roles(configuration: &configuration::Configuration, service_name: &str) -> Result<models::DbaasClickhouseRoles, Error<ListDbaasClickhouseRolesError>> {
    let local_var_service_name = service_name;
    ...
    configuration,
    reqwest::Method::GET,
    "/dbaas-clickhouse/{service_name}/role",
    path_params_map,
    query_params_option,
    body_payload_option,
    ).await
...
pub async fn reset_dbaas_clickhouse_user_password(configuration: &configuration::Configuration, service_name: &str, username: &str, reset_dbaas_valkey_user_password_request: models::ResetDbaasValkeyUserPasswordRequest) -> Result<models::DbaasUserClickhouseSecrets, Error<ResetDbaasClickhouseUserPasswordError>> {
    let local_var_service_name = service_name;
    let local_var_username = username;
...
pub async fn reveal_dbaas_thanos_user_password(configuration: &configuration::Configuration, service_name: &str, username: &str) -> Result<models::DbaasUserThanosSecrets, Error<RevealDbaasThanosUserPasswordError>> {
    let local_var_service_name = service_name;
    let local_var_username = username;
    ...
    configuration,
    reqwest::Method::GET,
    "/dbaas-thanos/{service_name}/user/{username}/password/reveal",
    path_params_map,
    query_params_option,
    body_payload_option,
    ).await
...
pub async fn start_dbaas_thanos_maintenance(configuration: &configuration::Configuration, name: &str) -> Result<models::Operation, Error<StartDbaasThanosMaintenanceError>> {
    let local_var_name = name;
...
pub async fn update_dbaas_service_thanos(configuration: &configuration::Configuration, name: &str, update_dbaas_service_thanos_request: models::UpdateDbaasServiceThanosRequest) -> Result<models::Operation, Error<UpdateDbaasServiceThanosError>> {
    let local_var_name = name;
    let local_var_update_dbaas_service_thanos_request = update_dbaas_service_thanos_request;
    ...
    let query_params_vec: Vec<(&str, String)> = Vec::new();
    let query_params_option = if query_params_vec.is_empty() { None } else { Some(query_params_vec.as_slice())};
            let body_payload_option = Some(local_var_update_dbaas_service_thanos_request);
