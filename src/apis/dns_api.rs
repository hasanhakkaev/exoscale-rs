...
pub async fn create_dns_domain(
    ...
    create_dns_domain_request: models::CreateDnsDomainRequest,
) -> Result<models::DnsDomain, Error<CreateDnsDomainError>> {
...
pub async fn create_dns_domain_record(
    configuration: &configuration::Configuration,
    domain_id: &str,
    create_dns_domain_record_request: models::CreateDnsDomainRecordRequest,
) -> Result<models::Operation, Error<CreateDnsDomainRecordError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_dns_domain(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Operation, Error<DeleteDnsDomainError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_dns_domain_record(
    ...
    domain_id: &str,
    record_id: &str,
) -> Result<models::Operation, Error<DeleteDnsDomainRecordError>> {
    let local_var_configuration = configuration;
...
pub async fn get_dns_domain(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::DnsDomain, Error<GetDnsDomainError>> {
    let local_var_configuration = configuration;
...
pub async fn get_dns_domain_record(
    ...
    domain_id: &str,
    record_id: &str,
) -> Result<models::DnsDomainRecord, Error<GetDnsDomainRecordError>> {
    let local_var_configuration = configuration;
...
pub async fn get_dns_domain_zone_file(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::GetDnsDomainZoneFile200Response, Error<GetDnsDomainZoneFileError>> {
    let local_var_configuration = configuration;
...
pub async fn list_dns_domain_records(
    configuration: &configuration::Configuration,
    domain_id: &str,
) -> Result<models::ListDnsDomainRecords200Response, Error<ListDnsDomainRecordsError>> {
    let local_var_configuration = configuration;
...
pub async fn list_dns_domains(
    configuration: &configuration::Configuration,
) -> Result<models::ListDnsDomains200Response, Error<ListDnsDomainsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_dns_domain_record(
    ...
    domain_id: &str,
    record_id: &str,
    update_dns_domain_record_request: models::UpdateDnsDomainRecordRequest,
) -> Result<models::Operation, Error<UpdateDnsDomainRecordError>> {
    let local_var_configuration = configuration;
